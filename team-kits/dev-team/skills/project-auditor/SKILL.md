...
description: >
  How the Project Auditor works: the read-only review procedure — sample requirements↔code
  claims, artifact consistency, gate health and structure vitals; score the judge rubric; hand back
...
6. **Hand back ONE Evidence item** (`kind: audit`, `related` = the PR or the repo-wide scope you audited):
