...
WHY THIS FILE EXISTS. `harness doctor` treats the enumeration as authoritative: a capability that
    ...
    return json.dumps(
        {"schema": 1,
         ...
         "note": "Generated by tools/gen_known_holes.py from pytest's own marker collection — do "
                 "not hand-edit. `harness doctor` forces every capability named here to "
